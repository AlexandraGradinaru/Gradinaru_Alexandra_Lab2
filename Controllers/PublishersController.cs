...
using Gradinaru_Alexandra_Lab2.Models;
using Gradinaru_Alexandra_Lab2.Models.LibraryViewModels;

namespace Gradinaru_Alexandra_Lab2.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var publisher = await _context.Publishers.Include(i => i.PublishedBooks).ThenInclude(i => i.Book).AsNoTracking().FirstOrDefaultAsync(m => m.ID == id);
            if (publisher == null)
            {
                return NotFound();
            }
